...
const HistoryCard = ({
    ...
    return (
        ...
        >
            <View style={[
                styles.card,
                expanded && !isSelectMode && styles.cardExpanded,
                isSelected && styles.cardSelected,
            ]}>
                {/* Selection indicator strip */}
                <View style={[styles.strip, { backgroundColor: isSelected ? '#D81B60' : riskColor }]} />
                    ...
                    <View style={styles.cardHeader}>
                        ...
                        {isSelectMode && (
                            <View style={styles.checkbox}>
                                {isSelected
                                    ? <CheckCircle2 size={22} color="#D81B60" />
...
const styles = StyleSheet.create({
    ...
    pill: {
        flexDirection: 'row', alignItems: 'center', gap: 4,
        backgroundColor: '#F8FAFC', paddingHorizontal: 8, paddingVertical: 4,
    ...
    profileRow: {
        ...
        alignItems: 'flex-end', paddingVertical: 9, paddingHorizontal: 12,
    },

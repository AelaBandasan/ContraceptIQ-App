...
MODEL_JOBLIB = os.path.join(
    _ML_ROOT, "src", "models", "models_high_risk_v4", "xgb_high_recall.joblib"
)
ARTIFACTS_DIR = os.path.join(_ML_ROOT, "src", "models", "models_high_risk_v4")
...
def save_permutation_artifacts(df, artifacts_dir):
    ...
    csv_path = os.path.join(artifacts_dir, "feature_importance_v4_permutation.csv")
    png_path = os.path.join(artifacts_dir, "feature_importance_v4_permutation.png")
...
def save_grouped_artifacts(grouped_df, artifacts_dir):
    ...
    csv_path = os.path.join(artifacts_dir, "feature_importance_v4_permutation_grouped.csv")
    png_path = os.path.join(artifacts_dir, "feature_importance_v4_permutation_grouped.png")
...
def save_shap_artifacts(shap_values, feature_names, X_transformed_df, artifacts_dir):
    ...
    png_path = os.path.join(artifacts_dir, "feature_importance_v4_shap_summary.png")
    csv_path = os.path.join(artifacts_dir, "feature_importance_v4_shap_values.csv")
